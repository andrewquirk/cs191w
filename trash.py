...
#         'http://abcnews.com',
#         'http://msnbc.com']
#urls = ['http://foxnews.com', 'http://motherjones.com']
...
for x in range(8):
    for y in ['D', 'R']:
        ...
        for speech in agg[x][y]:
            ...
            if (total_r > total_d):
                assign_r.append(speech)
            else:
                assign_d.append(speech)
            t_d += total_d
            t_r += total_r
        print('The number of articles classified as R for 8 '+ y + ': ' + str(len(assign_r)))
        print('The number of articles classified as D for 8 '+ y + ': ' + str(len(assign_d)))
